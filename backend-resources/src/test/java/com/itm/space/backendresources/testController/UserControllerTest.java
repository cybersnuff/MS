...
public class UserControllerTest extends BaseIntegrationTest {
    ...
    public void testGetUserById() throws Exception {
        ...
        UserResponse userResponse = new UserResponse("john_doe",
                "Goshin",
                "myEmail.com",
                List.of("USER"),
                List.of("Manager"));
        ...
        mvc.perform(get("/api/users/{id}", id.toString()))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("myEmail.com"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Goshin"))
                .andReturn();
    }
